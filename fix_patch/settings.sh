...
FIXVERSION=1.06
#   (actually this version is 1.066 - see wiki page for details)
#   (KJ note: this gets saved in the FIX feature output directory, then checked when running classifier)
...
if [ -z "${FSL_FIX_MATLAB_ROOT}" ]; then
       ...
       #FSL_FIX_MATLAB_ROOT=/export/matlab/MCR/R2012a/v717
       
       #FSL_FIX_MATLAB_ROOT=/opt/mcr/v83
       FSL_FIX_MATLAB_ROOT=/opt/mcr
fi
# On OS X this will most likely be something like /Applications/MATLAB_R20XX.app
...
#FSL_FIX_WBC='/export/HCP/workbench-v1.1.1/bin_rh_linux64/wb_command'
