...
main()
{
	...
	if [ -e "${ResultsFolder}/Movement_Regressors_demean.txt" ] ; then 
		#for multi-run-ICA case
		motionparameters="${ResultsFolder}/Movement_Regressors_demean" #No .txt
	else
